...
import (
	...
	model "github.com/m4kson/rocket-factory/payment/internal/model"
...
// PayOrder provides a mock function with given fields: ctx
func (_m *PaymentService) PayOrder(ctx context.Context) (*model.PayOrderResponse, error) {
	ret := _m.Called(ctx)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*model.PayOrderResponse, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) *model.PayOrderResponse); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
...
//   - ctx context.Context
func (_e *PaymentService_Expecter) PayOrder(ctx interface{}) *PaymentService_PayOrder_Call {
	return &PaymentService_PayOrder_Call{Call: _e.mock.On("PayOrder", ctx)}
}

func (_c *PaymentService_PayOrder_Call) Run(run func(ctx context.Context)) *PaymentService_PayOrder_Call {
...
func (_c *PaymentService_PayOrder_Call) RunAndReturn(run func(context.Context) (*model.PayOrderResponse, error)) *PaymentService_PayOrder_Call {
	_c.Call.Return(run)
	return _c
}
