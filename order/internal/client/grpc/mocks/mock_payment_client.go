...
// PayOrder provides a mock function with given fields: ctx, requestModel
func (_m *PaymentClient) PayOrder(ctx context.Context, requestModel model.PayOrderRequest) (model.PayOrderResponse, error) {
	ret := _m.Called(ctx, requestModel)
...
//   - ctx context.Context
//   - requestModel model.PayOrderRequest
func (_e *PaymentClient_Expecter) PayOrder(ctx interface{}, requestModel interface{}) *PaymentClient_PayOrder_Call {
	return &PaymentClient_PayOrder_Call{Call: _e.mock.On("PayOrder", ctx, requestModel)}
}

func (_c *PaymentClient_PayOrder_Call) Run(run func(ctx context.Context, requestModel model.PayOrderRequest)) *PaymentClient_PayOrder_Call {
...
func (_c *PaymentClient_PayOrder_Call) Return(_a0 model.PayOrderResponse, _a1 error) *PaymentClient_PayOrder_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *PaymentClient_PayOrder_Call) RunAndReturn(run func(context.Context, model.PayOrderRequest) (model.PayOrderResponse, error)) *PaymentClient_PayOrder_Call {
	_c.Call.Return(run)
	return _c
}
